...
export async function POST(request: NextRequest) {
  ...
  const { data, error } = await admin.from("manual_shows").insert({
    ...
    end_date: clean(body.endDate, 20) || clean(body.startDate, 20) || null,
    start_time: clean(body.start_time, 20) || null,
    end_time: clean(body.end_time, 20) || null,
    schedule_note: clean(body.schedule_note, 3000) || null,
    ...
    status: "검토중",
    show_time: clean(body.schedule_note || body.show_time, 3000),
