...
export default function ParentsFiftyPlusSection(){return <section id="fiftyplus" className="mx-auto w-full max-w-[1280px] px-6 py-14">
  <div className="border-t border-line pt-9">
    <div className="grid gap-7 lg:grid-cols-[.75fr_1.25fr]">
      <div className="max-w-md"><p className="text-[11px] font-semibold tracking-[.18em] text-gold">SHOWDAY 50+ LIFE</p><h2 className="mt-3 text-3xl font-black leading-tight text-paper">공연을 넘어,<br/>좋은 하루를 위한 콘텐츠</h2><p className="mt-4 text-sm leading-7 text-muted">힐링·뇌 휴식·발 건강·AI 생활 콘텐츠를 순차적으로 준비하고 있습니다.</p></div>
