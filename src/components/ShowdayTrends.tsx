...
export default function ShowdayTrends({ shows }: { shows: Show[] }){
  ...
  const groups=[
    ...
    {key:"GENRE", icon:PinIcon, title:"장르별 공연", desc:"원하는 장르를 선택해 현재·예정 공연을 바로 확인하세요.", shows:genrePicks},
  ];
