...
export default function ShowdayNow(){
  ...
  return <section id="showday-now" className="mx-auto max-w-[1280px] px-6 py-12">
    <div className="border-t border-line pt-8">
      <div className="flex items-end justify-between gap-5"><div><p className="text-[10px] font-semibold tracking-[.16em] text-gold">SHOWDAY NOW</p><h2 className="mt-2 text-3xl font-black text-paper">티켓오픈·공연소식</h2></div><span className="hidden text-[11px] text-muted sm:block">티켓오픈 · 예매 · 공연 발표 소식</span></div>
